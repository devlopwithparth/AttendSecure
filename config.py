...
class Config:
   # --- Core ---
   SECRET_KEY = os.envirn.get("SECRET_KEY","dev-secret-change-this-in-production")
   SQLALCHEMY_DATABASE_URL =os.environ.get("DATABASE_URL", f"sqlite:///{os.path.join(BASE_DIR,'instance','attendance.db')}")
...
SQLALCHEMY_ENGINE_OPTIONS = {
 ...
 # If True, OTPs are printed to console instead of emailed(useful for local dev/tsting) 
